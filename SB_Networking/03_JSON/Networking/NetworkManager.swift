...
class NetworkManager {
    ...
    static func fetchData(url: String, completion: @escaping (_ courses: [Course])->()) {
        ...
        URLSession.shared.dataTask(with: url) { (data, _, _) in
            ...
            do {
                ...
                //Конвертитуем Snake_case to CamelCase
    ...
    static func uploadImage(url: String) {
        let image = UIImage(named: "Firefox_new")!
        //Тут нужен мой ключ, но мне впадлу регистрироваться
        let httpHeaders = ["Autorization" : "Client-ID 1bd22b9ce396a4c"]
